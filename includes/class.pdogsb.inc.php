...
class PdoGsb//pour que l'application fonctionne
{
    ...
    {
        PdoGsb::$monPdo = new PDO(//recupere la connection a la base de donnée
            PdoGsb::$serveur . ';' . PdoGsb::$bdd,
            PdoGsb::$user,
            PdoGsb::$mdp
        );
        PdoGsb::$monPdo->query('SET CHARACTER SET utf8');//il s'agit d'une requete sql -afin que tout les formats restent en utf8
    }
     ...
     */
    public static function getPdoGsb()//on crée monPdoGsb
    {
